...
L'ensemble des effectifs calculés (avec et sans distinction des stades) sont regroupés dans un même jeu de données global : *ope_effectif*. 

```{r Creation tableau effectif total par ope 3}
