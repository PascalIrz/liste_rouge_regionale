...
```{r}
result_complet <- bind_rows(result_final_glm, result_final_lm)
```


Je souhaite maintenant regrouper les données où j'observe vraiment des résultats très significatifs : 

```{r}
result_complet_signif <- result_complet %>% 
  filter(sig == "***")
```
