...
subtitle: "Pré-traitements des données des opérations et des données individuelles des espèces"
author: "OFB Bretagne"
...
### Construction du fichier Excel "traits_biologiques"
...
1 et 2 : Ouvrages d'identification des poissons d'eau douce de France (Keith *et al.*, 2020 ; Derouch, 2024); 
3 : Observation des courbes de tailles dans le fichier R "estimation_taille_0+" à partir des données de taille de la base *aspe*; 
...
- "ind": Indifférencié = toutes classes d'âges confondues (ad + juv).
...
```{r Création id provisoire mei_id na}
