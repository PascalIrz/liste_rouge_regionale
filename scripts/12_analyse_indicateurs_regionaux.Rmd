...
reg_indicateur_lrr_pvalues_lm <- map_dfr(groups, function(group) {
...
reg_indicateur_lrr_pvalues_lm <- reg_indicateur_lrr_pvalues_lm %>% 
  filter(indicateur %in% c("densite_surface",
                           "pourcentage_juveniles",
                           "taux_occurrence"),
         stade == "ind")
...
print(reg_indicateur_lrr_pvalues_lm)
```
...
tab_reg_indicateur_lrr_pvalues_lm <- reg_indicateur_lrr_pvalues_lm %>%
...
tab_reg_indicateur_lrr_pvalues_lm # Affichage du tableau
```
