...
Il est ainsi observé (`r pop_id`) points de prélèvements ainsi que (`r pop_sta_id`) stations au sein de cette aire géographique. Une station peut contenir plusieurs points de prélèvements (l'inverse n'est en revanche pas possible - si c'est le cas, cf dernière partie "Vérification des données"). Après visualisation de l'aire géographique et de ses points de prélèvements associés, une sauvegarde des *pop_id* est réalisée dans la passerelle.
