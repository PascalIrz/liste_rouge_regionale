...
mes_pop_id <- bilan_annee_de_donnees %>% 
  filter(nombre_annees_totales > n_mini_annees) %>%  #(I.B Paramètres)
  pull(pop_id)
...
## Construction du dataframe de sélection des opérations finale 
...
## Sélection des opérations finale : Visualisation des efforts de pêches par station  
...
mapview(list(bzh_buff, mes_depts),
  ...
  mapview(sta_ope_bzh_2,
          ...
          alpha = 0.8,
          legend = TRUE,
          labels = list(text = sta_ope_bzh_2$nombre_ope_sta, cex = 1.5))
