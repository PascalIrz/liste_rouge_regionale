...
params:
  ...
  mes_stations: !r c("12436", "11290", "12402", "11743", "12291", "10468", "10734")
---
...
Ce script contient 2 script qui vont surement être effacé : le script anciennement 20_modèle d'occupation (quand je m'interessait aux modèles d'occupation) et le 25 qui porte sur le bayésien mais version ancienne donc à supprimer surement ! 
...
25_modelisation_croissance_demographique  + Modèles d'occupation 
...
no <- length(unique(mei_ope_selection$sta_id))
print(no)
...
```{r}
data_filter <- mef_ajouter_lots(data_filter) %>%
