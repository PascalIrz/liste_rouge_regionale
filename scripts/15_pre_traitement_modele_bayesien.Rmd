...
Cette partie de pré-traitement suit le tuto "Tutorial_popdynmodel_V1" réalisé par Mme Emmanuelle Dortel : Dans un premier temps, nous sélectionnons toutes les données pour le bassin Loire-Bretagne sur la période 1990-2023. Certaines opérations de pêche impliquant une pêche à plusieurs passes, cette information est inutile et nous ne gardons que la première passe.
