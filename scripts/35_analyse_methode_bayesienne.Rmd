...
```{r}
data_lrr <- filter(data_filter, esp_code_alternatif %in% mes_especes_lrr) %>%
...
```{r}
result_21_05 <- mod_popgrow(data_lrr,
                      var_id = "pop_id",
...
save(result_21_05,
     file = "../processed_data/modelisation_croissance_demographique_result_21_05.rda")
```
